...
def visualize_handler(server, superq, sdf_values, outside_values, final=False):
    ...
    if final:
        ...
        meshes = pred_handler.get_meshes(resolution=500)
...
def main():
    ...
    visualize_handler(server, superq, sdf_values, outside_values, final=True)
